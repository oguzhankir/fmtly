...
const CORS_HEADERS: Record<string, HeaderEntry> = {
    ...
    'access-control-allow-methods': {
        ...
        safe: true,
        recommendation: 'Only list methods your API actually uses. Avoid listing DELETE or PATCH unless needed.'
    },
...
const MIME_TABLE: MimeInfo[] = [
    // Text
    { mimeType: 'text/plain', extensions: ['txt', 'text', 'conf', 'def', 'list', 'log', 'in'], description: 'Plain text', binary: false },
    { mimeType: 'text/html', extensions: ['html', 'htm', 'shtml'], description: 'HTML document', binary: false },
    { mimeType: 'text/css', extensions: ['css'], description: 'Cascading Style Sheets', binary: false },
    { mimeType: 'text/javascript', extensions: ['js', 'mjs'], description: 'JavaScript', binary: false },
    { mimeType: 'text/xml', extensions: ['xml'], description: 'XML document (text)', binary: false },
    { mimeType: 'text/csv', extensions: ['csv'], description: 'Comma-separated values', binary: false },
    { mimeType: 'text/markdown', extensions: ['md', 'markdown'], description: 'Markdown document', binary: false },
    { mimeType: 'text/calendar', extensions: ['ics', 'ifb'], description: 'iCalendar format', binary: false },
    { mimeType: 'text/yaml', extensions: ['yaml', 'yml'], description: 'YAML data', binary: false },
    { mimeType: 'text/tab-separated-values', extensions: ['tsv'], description: 'Tab-separated values', binary: false },
    { mimeType: 'text/rtf', extensions: ['rtf'], description: 'Rich Text Format', binary: false },
    { mimeType: 'text/vcard', extensions: ['vcard', 'vcf'], description: 'vCard contact format', binary: false },

    // Application / Structured Data
    { mimeType: 'application/json', extensions: ['json'], description: 'JSON data', binary: false },
    { mimeType: 'application/ld+json', extensions: ['jsonld'], description: 'JSON-LD linked data', binary: false },
    { mimeType: 'application/xml', extensions: ['xml', 'xsd', 'xsl'], description: 'XML document', binary: false },
    { mimeType: 'application/x-yaml', extensions: ['yaml', 'yml'], description: 'YAML (alternative type)', binary: false },
    { mimeType: 'application/toml', extensions: ['toml'], description: 'TOML configuration', binary: false },
    { mimeType: 'application/graphql', extensions: ['graphql', 'gql'], description: 'GraphQL schema/query', binary: false },
    { mimeType: 'application/x-www-form-urlencoded', extensions: [], description: 'URL-encoded form data', binary: false },
    { mimeType: 'multipart/form-data', extensions: [], description: 'Multipart form data', binary: false },
    ...
    { mimeType: 'application/gzip', extensions: ['gz', 'gzip'], description: 'GZIP compressed', binary: true },
    { mimeType: 'application/x-bzip2', extensions: ['bz2'], description: 'BZIP2 compressed', binary: true },
    { mimeType: 'application/x-7z-compressed', extensions: ['7z'], description: '7-Zip archive', binary: true },
    { mimeType: 'application/x-rar-compressed', extensions: ['rar'], description: 'RAR archive', binary: true },
    ...
    { mimeType: 'application/msword', extensions: ['doc'], description: 'Microsoft Word (legacy)', binary: true },
    { mimeType: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', extensions: ['docx'], description: 'Microsoft Word', binary: true },
    { mimeType: 'application/vnd.ms-excel', extensions: ['xls'], description: 'Microsoft Excel (legacy)', binary: true },
    { mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', extensions: ['xlsx'], description: 'Microsoft Excel', binary: true },
    { mimeType: 'application/vnd.ms-powerpoint', extensions: ['ppt'], description: 'PowerPoint (legacy)', binary: true },
    { mimeType: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', extensions: ['pptx'], description: 'PowerPoint', binary: true },
    { mimeType: 'application/vnd.oasis.opendocument.text', extensions: ['odt'], description: 'OpenDocument text', binary: true },
    { mimeType: 'application/vnd.oasis.opendocument.spreadsheet', extensions: ['ods'], description: 'OpenDocument spreadsheet', binary: true },
    { mimeType: 'application/epub+zip', extensions: ['epub'], description: 'EPUB ebook', binary: true },
    { mimeType: 'application/rtf', extensions: ['rtf'], description: 'Rich Text Format (binary)', binary: true },

    // Application / Binary / Executables
    { mimeType: 'application/octet-stream', extensions: ['bin', 'exe', 'dll', 'so', 'dmg', 'iso'], description: 'Generic binary data', binary: true },
    { mimeType: 'application/x-msdownload', extensions: ['exe', 'msi'], description: 'Windows executable', binary: true },
    { mimeType: 'application/x-apple-diskimage', extensions: ['dmg'], description: 'macOS disk image', binary: true },
    { mimeType: 'application/java-archive', extensions: ['jar'], description: 'Java archive', binary: true },
    { mimeType: 'application/wasm', extensions: ['wasm'], description: 'WebAssembly binary', binary: true },
    ...
    { mimeType: 'font/woff', extensions: ['woff'], description: 'Web Open Font Format', binary: true },
    { mimeType: 'font/woff2', extensions: ['woff2'], description: 'Web Open Font Format 2', binary: true },
    { mimeType: 'application/vnd.ms-fontobject', extensions: ['eot'], description: 'Embedded OpenType font', binary: true },

    // Application / Crypto / Auth
    { mimeType: 'application/x-x509-ca-cert', extensions: ['crt', 'cer', 'der'], description: 'X.509 certificate', binary: true },
    { mimeType: 'application/x-pem-file', extensions: ['pem'], description: 'PEM certificate/key', binary: false },
    { mimeType: 'application/pkcs8', extensions: ['p8', 'key'], description: 'Private key (PKCS#8)', binary: true },

    // Images
    { mimeType: 'image/jpeg', extensions: ['jpg', 'jpeg', 'jpe'], description: 'JPEG image', binary: true },
    ...
    { mimeType: 'image/svg+xml', extensions: ['svg', 'svgz'], description: 'SVG vector image', binary: false },
    ...
    { mimeType: 'image/vnd.microsoft.icon', extensions: ['ico'], description: 'Windows icon (official)', binary: true },
    { mimeType: 'image/heic', extensions: ['heic', 'heif'], description: 'HEIC/HEIF image (Apple)', binary: true },
    { mimeType: 'image/jxl', extensions: ['jxl'], description: 'JPEG XL image', binary: true },

    // Audio
    { mimeType: 'audio/mpeg', extensions: ['mp3', 'mp2'], description: 'MPEG audio (MP3)', binary: true },
    { mimeType: 'audio/mp4', extensions: ['m4a', 'mp4a'], description: 'AAC/MP4 audio', binary: true },
    ...
    { mimeType: 'audio/flac', extensions: ['flac'], description: 'FLAC lossless audio', binary: true },
    { mimeType: 'audio/aac', extensions: ['aac'], description: 'AAC audio', binary: true },
    { mimeType: 'audio/x-midi', extensions: ['midi', 'mid'], description: 'MIDI audio', binary: true },
    ...
    { mimeType: 'video/quicktime', extensions: ['mov', 'qt'], description: 'QuickTime video', binary: true },
    { mimeType: 'video/x-msvideo', extensions: ['avi'], description: 'AVI video', binary: true },
    { mimeType: 'video/x-matroska', extensions: ['mkv', 'mk3d'], description: 'Matroska (MKV) video', binary: true },
    ...
    // Code / Programming
    { mimeType: 'application/x-httpd-php', extensions: ['php', 'phtml'], description: 'PHP source', binary: false },
    { mimeType: 'application/x-python-code', extensions: ['py', 'pyc'], description: 'Python source', binary: false },
    { mimeType: 'application/x-ruby', extensions: ['rb', 'rbw'], description: 'Ruby source', binary: false },
    { mimeType: 'application/x-sh', extensions: ['sh', 'bash', 'zsh'], description: 'Shell script', binary: false },
    { mimeType: 'application/x-bat', extensions: ['bat', 'cmd'], description: 'Windows batch script', binary: false },
    { mimeType: 'application/typescript', extensions: ['ts', 'tsx'], description: 'TypeScript source', binary: false },
    ...
    { mimeType: 'application/x-java-source', extensions: ['java'], description: 'Java source', binary: false },
    { mimeType: 'text/x-kotlin', extensions: ['kt', 'kts'], description: 'Kotlin source', binary: false },
    ...
    { mimeType: 'text/x-c++src', extensions: ['cpp', 'cc', 'cxx', 'hpp'], description: 'C++ source', binary: false },
    ...
    { mimeType: 'text/x-r', extensions: ['r', 'R'], description: 'R statistical language', binary: false },
    ...
    { mimeType: 'application/x-elixir', extensions: ['ex', 'exs'], description: 'Elixir source', binary: false },

    // Data / Markup
    { mimeType: 'application/x-ndjson', extensions: ['ndjson', 'jsonl'], description: 'Newline-delimited JSON', binary: false },
    { mimeType: 'application/geo+json', extensions: ['geojson'], description: 'GeoJSON', binary: false },
    { mimeType: 'application/x-protobuf', extensions: ['proto', 'pb'], description: 'Protocol Buffers', binary: true },
    { mimeType: 'application/x-msgpack', extensions: ['msgpack', 'mpk'], description: 'MessagePack binary', binary: true },
    { mimeType: 'application/cbor', extensions: ['cbor'], description: 'CBOR binary', binary: true },
    { mimeType: 'application/x-latex', extensions: ['tex', 'latex'], description: 'LaTeX document', binary: false },
    ...
    { mimeType: 'application/atom+xml', extensions: ['atom'], description: 'Atom feed', binary: false },
    ...
    // Config
    { mimeType: 'application/x-env', extensions: ['env'], description: 'Environment variables file', binary: false },
    { mimeType: 'text/x-ini', extensions: ['ini', 'cfg', 'properties'], description: 'INI configuration', binary: false },
    { mimeType: 'application/x-dockerfile', extensions: ['dockerfile'], description: 'Dockerfile', binary: false },
    { mimeType: 'application/x-docker-compose', extensions: ['docker-compose.yml'], description: 'Docker Compose', binary: false },
];
...
function cronToHuman(expr: string): string {
    ...
    if (parts.length === 6) {
        ...
        void sec; void dom; void month; void dow;
        if (min !== '*' && hour !== '*') {
