const registryIt: Record<string, string> = {
	...
	'ui.diff.labels.input_panel': 'Pannello di input diff',
	'ui.diff.controls.ignore_order': 'Ignora ordine degli array',
	'ui.diff.controls.only_diffs': 'Mostra solo le differenze',
	'ui.diff.controls.case_sensitive': 'Distingui maiuscole',
	...
	'ui.diff.controls.export_md': 'Scarica report Markdown',
	'ui.diff.controls.export_csv': 'Scarica CSV',
	'ui.diff.view.list': 'Vista elenco',
	'ui.diff.view.monaco': 'Vista diff integrata',
	'ui.diff.view.inline_toggle': 'Alterna inline / affiancato',
	...
	'ui.diff.summary.empty': 'Inserisci JSON in entrambi i pannelli per confrontare',
	...
	'ui.diff.toast.format_error': 'Impossibile formattare — JSON non valido',
	'ui.diff.toast.patch_success': 'JSON Patch copiato negli appunti',
	'ui.diff.toast.copy_value': 'Valore copiato',
	'ui.diff.toast.share_copied': 'Link di condivisione copiato',
	'ui.diff.meta.chars': 'car.',
	'ui.diff.empty.hint': 'Incolla JSON in entrambi i pannelli in alto per confrontarli.',
	...
	'ui.loaded_sample': '{label} caricato',
