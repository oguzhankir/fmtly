const registryFr: Record<string, string> = {
	...
	'tool.image-svg-optimizer.display_name': 'Optimiseur SVG',
	'tool.image-svg-optimizer.tagline':
		'Optimisez le SVG avec SVGO, aperçu en direct et confidentialité totale dans le navigateur',
	...
	'tool.image-svg-optimizer.faq.0.question': 'Mon SVG est-il téléversé vers un serveur ?',
	'tool.image-svg-optimizer.faq.0.answer':
		'Non. L’optimisation s’exécute entièrement dans votre navigateur avec chargement dynamique de SVGO. Votre SVG reste sur votre appareil.',
	'tool.image-svg-optimizer.faq.1.question': 'Quelles optimisations puis-je contrôler ?',
	'tool.image-svg-optimizer.faq.1.answer':
		'Vous pouvez piloter la suppression des métadonnées, commentaires et <desc>, le nettoyage des IDs, la fusion de groupes, la simplification des chemins, la fusion des chemins, le tri des attributs, la suppression des dimensions, le multipass et l’output formaté.',
	'tool.image-svg-optimizer.faq.2.question': 'Comment vérifier le rendu en toute sécurité ?',
	'tool.image-svg-optimizer.faq.2.answer':
		'L’outil affiche les aperçus source et optimisé localement sous forme d’images du navigateur afin de comparer le rendu visuel avant téléchargement.',
	...
	'tool.image-svg-optimizer.use_case.3':
		'Comparer le markup source et optimisé avant de versionner des assets vectoriels',
	'ui.svg_optimizer.paste': 'Coller le SVG',
	'ui.svg_optimizer.paste_empty': 'Le presse-papiers est vide',
	'ui.svg_optimizer.paste_success': 'Markup SVG collé',
	'ui.svg_optimizer.paste_error': 'Échec du collage depuis le presse-papiers',
	'ui.svg_optimizer.no_file': 'Aucun SVG sélectionné',
	'ui.svg_optimizer.worker_active':
		'Grand SVG détecté (>{size}). L’optimisation s’exécute dans un Web Worker.',
	'ui.svg_optimizer.worker_used': 'Traité hors du fil principal',
	'ui.svg_optimizer.worker_failed':
		'L’optimisation dans le Worker a échoué. Retour au fil principal.',
	'ui.svg_optimizer.optimize_failed': 'L’optimisation SVG a échoué',
	'ui.svg_optimizer.file_read_error': 'Impossible de charger le fichier SVG',
	'ui.svg_optimizer.file_loaded': '{name} chargé',
	'ui.svg_optimizer.sample_loaded': 'SVG d’exemple chargé',
	'ui.svg_optimizer.input_cleared': 'Entrée SVG effacée',
	'ui.svg_optimizer.copy_empty': 'Rien à copier',
	'ui.svg_optimizer.copy_success': 'SVG optimisé copié',
	'ui.svg_optimizer.copy_error': 'Échec de la copie',
	'ui.svg_optimizer.download_empty': 'Rien à télécharger',
	'ui.svg_optimizer.download_success': '{filename} téléchargé',
	'ui.svg_optimizer.download_error': 'Échec du téléchargement',
	'ui.svg_optimizer.source_status': '{size} · {elements} éléments',
	...
	'ui.svg_optimizer.option.remove_desc': 'Supprimer <desc>',
	'ui.svg_optimizer.option.cleanup_ids': 'Nettoyer les IDs',
	'ui.svg_optimizer.option.collapse_groups': 'Fusionner les groupes',
	'ui.svg_optimizer.option.convert_path_data': 'Simplifier les chemins',
	'ui.svg_optimizer.option.merge_paths': 'Fusionner les chemins',
	'ui.svg_optimizer.option.sort_attrs': 'Trier les attributs',
	'ui.svg_optimizer.option.remove_dimensions': 'Supprimer largeur/hauteur',
	'ui.svg_optimizer.option.multipass': 'Lancer l’optimisation multipass',
	...
	'ui.svg_optimizer.stat.optimized_elements': 'Éléments optimisés',
	'ui.svg_optimizer.stat.size_delta': 'Écart de taille',
	'ui.svg_optimizer.stat.size_delta_helper': 'négatif = plus petit',
	'ui.svg_optimizer.stat.duration': 'Durée',
	'ui.svg_optimizer.stat.runtime_helper': 'par exécution d’optimisation',
	'ui.svg_optimizer.geometry_source': 'Géométrie source',
	'ui.svg_optimizer.geometry_output': 'Géométrie optimisée',
	'ui.svg_optimizer.preview_mode': 'Aperçu',
	'ui.svg_optimizer.code_mode': 'Code',
	'ui.svg_optimizer.processing': 'Optimisation...',
	'ui.svg_optimizer.source_preview_label': 'Aperçu source',
	'ui.svg_optimizer.source_preview_alt': 'Aperçu du SVG source',
