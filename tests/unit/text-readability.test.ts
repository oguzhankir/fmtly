...
describe('Text Engine - Readability', () => {
    ...
    it('computes expected readability bounds for a complex text', async () => {
        const text = 'The metaphysical paradigm established by the philosophical discourse intrinsically mandates a highly sophisticated intellectual methodology.';
        const result = readability(text);
